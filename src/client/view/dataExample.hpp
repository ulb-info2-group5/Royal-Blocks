...
const std::array<std::array<colors, WIDTH>, HEIGHT> EXEMPLE_BOARD =
    ...
    {{
        {colors::BLACK, colors::BLACK, colors::BLACK, colors::DARK_BLUE,
         colors::DARK_BLUE, colors::BLACK, colors::BLACK, colors::BLACK,
        ...
        //  colors::DARK_BLUE,colors::DARK_BLUE, colors::BLACK,colors::BLACK,
        //  colors::BLACK,colors::BLACK, colors::BLACK}
    }};

const std::vector<std::array<std::array<colors, WIDTH>, HEIGHT>>
    EXEMPLE_BOARDS = {EXEMPLE_BOARD, EXEMPLE_BOARD, EXEMPLE_BOARD,
