...
/*
* @brief Handle the Ctrl+C and Ctrl+Z event to prevent the application from closing
*
* @param component The component to handle the Ctrl+C and Ctrl+Z event
* @return ftxui::Component The component with the Ctrl+C and Ctrl+Z event handled
*/
