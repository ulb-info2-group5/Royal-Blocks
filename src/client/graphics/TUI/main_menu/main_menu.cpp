...
namespace TUI {
    ...
    void MainMenu::handleChoice() {
        ...
        case MainMenuState::JOIN_GAME:
            gameMenu_.render(
                TypeGame::JOIN_GAME); // Can join all the games modes
            break;
        ...
        mainMenuWindow_ = ftxui::Renderer(
            ...
            [&] {
                return ftxui::vbox({
                           ...
                           ftxui::separator(),
                           ftxui::text(std::string(STR_WELCOME))
                               | ftxui::center,
                           ftxui::separator(),
                           buttonPlay_->Render(),
    ...
    void MainMenu::displayProfileManagerButton() {
        ...
        submitButton_ = ftxui::Button(
            ...
            [&] {
                controller_.changeProfile(username_,
                                          password_); // profile screen
                mainTui_.stopRender();
            },
            GlobalButtonStyle());
    }
    ...
    void MainMenu::displayProfileManagerWindow() {
        ...
        profileManagerWindow_ = ftxui::Renderer(
            ftxui::Container::Vertical({inputChangeUsername_,
                                        inputChangePassword_, submitButton_,
                                        buttonBack_}),
            [&] {
                return ftxui::vbox({
