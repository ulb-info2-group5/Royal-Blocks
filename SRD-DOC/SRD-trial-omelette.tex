...
\begin{figure}[htbp]
    \centering
    \includesvg{./uml/usescase/connexion/connexion.svg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{uml/usecase/menu-principal/menu_principal.png}
    \caption{Diagramme Use Case du Menu Principal}
    \label{fig:main-menu}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{uml/usecase/en-jeu/endless.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{uml/usecase/en-jeu/dual-normal.png}
