...
\usepackage{svg} %for inserting svg 
...
\begin{figure}
    \centering
    \includesvg[width=0.9\textwidth]{SRD-DOC/uml/usescase/connexion/connexion}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{SRD-DOC/uml/usecase/menu-principal/menu_principal.png}
    \caption{Diagramme Use Case du Menu Principal}
    \label{fig:main-menu}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{SRD-DOC/uml/usecase/en-jeu/endless.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{SRD-DOC/uml/usecase/en-jeu/dual-normal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{SRD-DOC/uml/usecase/en-jeu/royal-competition.png}
