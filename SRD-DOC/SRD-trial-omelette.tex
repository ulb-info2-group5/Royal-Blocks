...
\subsubsection*{Envoyer n malus}
\begin{itemize}
    \item \textbf{Acteur}: Joueur
    \item \textbf{Use case}: Envoyer n malus
    \item \textbf{Description}: Envoie une ou plusieurs de malus à l'adversaire.
    \item \textbf{Précondition}: Le joueur a complété au moins deux lignes dans sa grille.
    \item \textbf{Postcondition}: L'adversaire reçoit un ou plusieurs malus.
...
\subsubsection*{Changer la cible des malus}
\begin{itemize}
    \item \textbf{Acteur}: Joueur
    \item \textbf{Use case}: Changer la cible des malus
    \item \textbf{Description}: Permet au joueur changer l'adversaire recevant le malus
    \item \textbf{Précondition}: La partie est en cours et le joueur peut envoyer un ou plusieurs malus.
    \item \textbf{Postcondition}: Le joueur a sélectionné une nouvelle cible pour envoyer ses malus.
    \item \textbf{Cas exceptionnels}: Il n'y a plus d'autres joueurs dans la partie.
\end{itemize}

\subsubsection*{Choisir la cible des malus}
\begin{itemize}
    \item \textbf{Acteur}: Joueur
    \item \textbf{Use case}: Choisir la cible des malus
    \item \textbf{Description}: Le joueur choisit parmis ses adversaires sa nouvelle cible pour les malus.
    \item \textbf{Précondition}: La partie est en cours et le joueur peut envoyer un malus.
    \item \textbf{Postcondition}: Le joueur change la cible pour ses malus et envoie à un adversaire nouvellement désigné.
    \item \textbf{Cas exceptionnels}: Il n'y a plus d'autres joueurs dans la partie.
\end{itemize}

\subsubsection*{Envoyer n malus} (identique au mode Duel)
...
\subsubsection*{Envoyer un malus}
\begin{itemize}
    \item \textbf{Acteur}: Joueur
    \item \textbf{Use case}: Envoyer un malus
    \item \textbf{Description}: Le joueur envoie un malus à l'adversaire choisi.
    \item \textbf{Précondition}: La partie est en cours et le joueur peut envoyer un malus à un adversaire.
    \item \textbf{Postcondition}: Le joueur envoie le malus à l'adversaire choisi.
    \item \textbf{Cas exceptionnels}: Il n'y a plus d'autres joueurs dans la partie. 
\end{itemize}

\subsubsection*{Choisir un des malus à envoyer}
\begin{itemize}
    \item \textbf{Acteur}: Joueur
    \item \textbf{Use case}: choisir un des malus à envoyer
    \item \textbf{Description}: Le joueur a plusieurs options de malus à envoyer à l'adversaire choisi.
    \item \textbf{Précondition}: La partie est en cours et le joueur peut consommer sa barre d'énergie.
    \item \textbf{Postcondition}: Le joueur envoie un des malus proposés à l'adversaire visé.
    \item \textbf{Cas exceptionnels}: Il n'y a plus d'autres joueurs dans la partie.
\end{itemize}

\subsubsection*{Choisir la cible du malus} (identique au mode Classique)
