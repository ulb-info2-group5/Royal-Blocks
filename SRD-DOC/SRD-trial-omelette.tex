...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1\textwidth]{uml/sequence/connexion/connexionSequence.png}
    \caption{Diagramme de séquence de connexion}
    \label{fig:Royal-Competition}
\end{figure}
