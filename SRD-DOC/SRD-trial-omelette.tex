...
%il faudra les mettre en ordre alphabétique svp

\begin{itemize}
	\item \textbf{tetriminos}
	\item \textbf{malus}
	\item \textbf{bonus}
	% \item \textbf{tetriminos}
	% \item \textbf{tetriminos}
...
\begin{itemize}
    ...
    % il y a pas un cas exceptionnel où il n'est pas connecté au réseau ?
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Précondition}: L'utilisateur est authentifié et a choisi les options pour lancer une partie.
...
\begin{itemize}
    \item \textbf{Acteur}: Utilisateur
    \item \textbf{Use case}: Rejoindre une partie existante
    \item \textbf{Description}: Permet à l'utilisateur de rejoindre une partie existante sur invitation d'un utilisateur de sa liste d'amis.
    \item \textbf{Précondition}: L'utilisateur a reçu une invitation à une partie existante.
    \item \textbf{Postcondition}: L'utilisateur rejoint la partie.
    \item \textbf{Cas exceptionnels}: Invitation expirée, partie avec le nombre maximum de joueurs atteint.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Description}: Permet à l'utilisateur d'inviter un ami à une partie créée par soi-même.
    %je hais la formulation
    \item \textbf{Précondition}: L'ami est connecté et n'est pas dans une autre partie existante.
    \item \textbf{Postcondition}: L'invitation est envoyée à l'ami.
    \item \textbf{Cas exceptionnels}: L'ami n'accepte pas l'invitation.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Description}: Permet à l'utilisateur de choisir un mode de jeu parmis ceux proposés.
    \item \textbf{Précondition}: Une partie va être créer et l'utilisateur doit sélectionner le mode.
    %à  vérifier
    \item \textbf{Postcondition}: Le mode de jeu est défini pour la partie.
    \item \textbf{Cas exceptionnels}: Mode de jeu non disponible ou l'utilisateur ne possède pas assez d'amis dans sa liste pour pouvoir lancer une partie multijoueur.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Postcondition}: Les informations sur le profil sont mises à jour.
    \item \textbf{Cas exceptionnels}: Échec de la mise à jour des informations. % dû à une mauvaise connexion ?
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Cas exceptionnels}: Classement indisponible, problème de réseau
\end{itemize}
...
\subsubsection*{Déplacer la pièce} (identique à Endless)


\subsubsection*{Tourner la pièce} (identique à Endless)
