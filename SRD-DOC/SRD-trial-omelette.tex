...
Pour accéder au jeu, l'utilisateur devra s'authentifier à l'aide d'un nom d'utilisateur et de son mot de passe associé. Notamment, le serveur devra vérifier que toutes les règles du jeu soient appliquées correctement durant la partie afin qu'aucun utilisateur ne puisse tricher. 
