...
\begin{itemize}
	...
	\item \textbf{malus} : Pénalité infligée à un jouer par un de ses adversaires. Le mallus se manifeste par l'ajout d'une ou de plusieurs lignes supplémentaires en bas de la grille du receveur, poussant les blocs existants vers le haut et rapprochant le joueur de la défaite.
