...
\begin{figure}[!h]
	\centering
	 \includegraphics[scale=0.6]{../res/uml/class/GameStateViewClass.png}
...
\begin{figure}[!h]
	\centering
	 \includegraphics[scale=0.6]{../res/uml/class/GameEngineClass.png}
...
\begin{figure}[!ht]
	\centering
	 \includegraphics[scale=0.5]{../res/uml/class/BindingClass.png}
...
La partie Network du serveur permet de recevoir et envoyer les paquets à l'objet correspondant qui traite ces derniers.

La classe Network possède une instance de ClientManager. Cette dernière s'occupe de l'inscription, l'authentification d'un utlisateur. Après la connexion établie entre le client et le serveur, le ClientManager s'occupe de l'envoi et la réception des messages si l'utilisateur authentifié a recours à la messagerie de l'application. 

\begin{figure}[!ht]
	\centering
	 \includegraphics[scale=0.5]{../res/uml/class/NetworkClass.png}
...
L'architecture du client possède plusieurs parties qui permettent de communiquer avec le serveur et de plus afficher les informations sur l'écran de l'utilisateur.
...
La partie Network du Client est faite par la classe NetworkManager. Elle établit et met fin correctement la connexion avec le serveur. De plus, elle reçoit du serveur tous types de paquets. Le traitement de ces paquets sera fait à un autre moment. 
